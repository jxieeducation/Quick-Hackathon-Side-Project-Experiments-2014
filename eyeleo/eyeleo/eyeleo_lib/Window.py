...
import logging
logger = logging.getLogger('eyeleo_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by EyeleoWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseEyeleoWindow object.
        """
        builder = get_builder('EyeleoWindow')
        new_object = builder.get_object("eyeleo_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a EyeleoWindow object with it in order to finish
        initializing the start of the new EyeleoWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.eyeleo")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('eyeleo')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for eyeleo."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for eyeleo."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the EyeleoWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the EyeleoWindow is closed."""
