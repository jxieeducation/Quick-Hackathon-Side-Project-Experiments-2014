                    ...
                    [service discoverCharacteristics:[service characteristics] withBlock:^(NSDictionary *chDict, NSError *error) {
                        for (NSString *key in chDict) {
                            ...
                            [ct discoverDescriptorsWithBlock:^(NSArray *ydescriptors, NSError *error) {
                                ...
                                if ([thisService isKindOfClass:[DEAAccelerometerService class]] && !self.accelerometer.isOn) {
                                    [((DEAAccelerometerService *)service) turnOn];
                                    [((DEAAccelerometerService *)service) configPeriod:10];
//                                } else if ([thisService isKindOfClass:[DEAGyroscopeService class]] && !self.gyroscope.isOn) {
//                                    [((DEAGyroscopeService *)service) turnOn];
                                }
                            }];
                        }
                    }];
